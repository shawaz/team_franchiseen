...
export const getUploadSignature = action({
  ...
  handler: async (ctx) => {
    // Use environment variables for Uploadcare credentials
    const secretKey = process.env.UPLOADCARE_SECRET_KEY || "419a1bc8f14196938f79";
    const publicKey = process.env.UPLOADCARE_PUBLIC_KEY || "3b1f1c32502a35fc73cc";
    ...
    console.log('Generated Uploadcare signature:', {
      publicKey,
      expire,
